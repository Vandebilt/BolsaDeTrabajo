<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="ValidacionEmpresa.aspx.cs" Inherits="FACPYA.BolsaDeTrabajo.Presentacion.ValidacionEmpresa" %>
                ...
                <div class="modal-body body-sustentante">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <asp:Label ID="lblGiro" CssClass="form-control textbox" runat="server"
                                Style="height: auto; white-space: pre-wrap; word-break: break-word;"></asp:Label>
                        </div>
                        <div class="col-md-4 mb-3">
                            <span class="label">Tamaño de Empresa:</span>
                            <asp:Label ID="lblTamanioEmpresa" CssClass="form-control textbox" runat="server"></asp:Label>
                        </div>
                        <div class="col-md-4 mb-3">
                            <span class="label">Tipo de Empresa:</span>
                            <asp:Label ID="lblTipoEmpresa" CssClass="form-control textbox" runat="server"></asp:Label>
                        </div>
                        <div class="col-md-12 mb-3">
                            <span class="label">Dirección:</span>
                            <asp:Label ID="lblDireccion" CssClass="form-control textbox" runat="server"
                                Style="height: auto; white-space: pre-wrap; word-break: break-word;"></asp:Label>
                        </div>
                        <div class="col-md-4 mb-3">
                            <span class="label">Correo</span>
                            <asp:Label ID="lblCorreo" CssClass="form-control textbox" runat="server"></asp:Label>
                        </div>
                        <div class="col-md-6 mb-3">
                            <span class="label">URL Página Web:</span>
                            <asp:HyperLink ID="lnkPaginaWeb" CssClass="form-control textbox d-block" runat="server"
                                Target="_blank" Style="height: auto; white-space: pre-wrap; word-break: break-word;"></asp:HyperLink>
                        </div>
                        <div class="col-md-6 mb-3">
                            <span class="label">Nombre de Contacto:</span>
                            <asp:Label ID="lblContactoNombre" CssClass="form-control textbox" runat="server"></asp:Label>
                        </div>
                        <div class="col-md-6 mb-3">
                            <span class="label">Puesto de Contacto:</span>
                            <asp:Label ID="lblContactoPuesto" CssClass="form-control textbox" runat="server"></asp:Label>
                        </div>
                        <div class="col-md-12 mb-3">
                            <span class="label">Misión:</span>
                            <asp:Label ID="lblMision" CssClass="form-control textbox" runat="server"
                                Style="height: auto; white-space: pre-wrap; word-break: break-word;"></asp:Label>
                        </div>
                        <div class="col-md-12 mb-3">
                            <span class="label">Visión:</span>
                            <asp:Label ID="lblVision" CssClass="form-control textbox" runat="server"
                                Style="height: auto; white-space: pre-wrap; word-break: break-word;"></asp:Label>
                        </div>
                        <div class="col-md-12 mb-3">
                            <span class="label">Regimen de Gastos Médicos:</span>
                            <asp:Label ID="lblRegimenGastosMedicos" CssClass="form-control textbox" runat="server"></asp:Label>
                        </div>
                    </div>
                    <div class="mt-3 table-responsive">
                    ...
                    <div class="col-md-12 form-floating mb-3">
                        <asp:TextBox ID="txtRetroPerfil" runat="server" CssClass="form-control textbox" MaxLength="155" placeholder="Retroalimentación General del Perfil"></asp:TextBox>
                        <asp:Label ID="lblRetroPerfil" runat="server" AssociatedControlID="txtRetroPerfil" CssClass="label" Text="Retroalimentación General del Perfil"></asp:Label>
                    </div>
                    <!-- Fin Controles -->
                </div>
