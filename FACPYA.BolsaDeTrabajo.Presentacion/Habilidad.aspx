<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="Habilidad.aspx.cs" Inherits="FACPYA.BolsaDeTrabajo.Presentacion.Habilidad" %>
                ...
                <div class="row p-2">
                    <div class="card h-50vh">
                        <div class="text-center p-2">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">Módulo Habilidad</h6>
                        </div>
                        <div class="card-body">
                            <!-- Controles -->
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <asp:DropDownList ID="ddlIdTipoHabilidad" runat="server" CssClass="form-control textbox select2-custom" placeholder="Tipo de Habilidad"></asp:DropDownList>
                                ...
                                <div class="col-md-12 mb-5">
                                    <div class="form-floating">
                                        <asp:TextBox ID="txtHabilidad" runat="server" CssClass="form-control textbox" MaxLength="50" onkeypress="return AllowOnlyLetters(event);" placeholder="Nombre Habilidad"></asp:TextBox>
                                        <asp:Label ID="lblHabilidad" runat="server" AssociatedControlID="txtHabilidad" CssClass="label" Text="Nombre Habilidad"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="card h-28vh">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                ALTA, BAJA Y MODIFICACION DE LAS HABILIDADES.
                            </div>
                ...
                <div class="row p-2">
                    <div class="card h-90vh">
                        <div class="text-center p-1">
                            <h5 class="card-title titulo"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Habilidad</h5>
                            ...
                            <div class="row mt-0">
                                ...
                                <div class="col-md-10">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating">
                                                <asp:DropDownList ID="ddlBusquedaIdTipoHabilidad" runat="server" CssClass="form-control textbox select2-custom" placeholder="Tipo de Habilidad"></asp:DropDownList>
                                                <asp:Label ID="lblBusquedaIdTipoHabilidad" runat="server" AssociatedControlID="ddlBusquedaIdTipoHabilidad" CssClass="label" Text="Tipo de Habilidad"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <asp:TextBox ID="txtBusquedaHabilidad" runat="server" CssClass="form-control textbox" MaxLength="50" placeholder="Habilidad"></asp:TextBox>
                                                <asp:Label ID="lblBusquedaHabilidad" runat="server" AssociatedControlID="txtBusquedaHabilidad" CssClass="label" Text="Habilidad"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
