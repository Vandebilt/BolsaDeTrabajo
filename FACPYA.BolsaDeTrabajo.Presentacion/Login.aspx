<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FACPYA.BolsaDeTrabajo.Presentacion.Login" %>
            ...
            <div class="container-login d-flex overflow-hidden">
                ...
                <div class="col-form p-4">
                    ...
                    <div id="divIniciarSesion" runat="server" visible="true">
                        <h6 class="title text-center  mb-4">Iniciar Sesión</h6>
                        <div class="form-floating mb-2">
                            <asp:TextBox ID="txtCuenta" runat="server" CssClass="form-control textbox" MaxLength="255" placeholder="Cuenta"></asp:TextBox>
                            <asp:Label ID="lblCuenta" runat="server" AssociatedControlID="txtCuenta" CssClass="label" Text="Cuenta"></asp:Label>
                        </div>
                        <div class="form-floating mb-4">
                            <asp:TextBox ID="txtContrasenia" runat="server" CssClass="form-control textbox" MaxLength="50" type="password" placeholder="Contraseña"></asp:TextBox>
                            <asp:Label ID="lblContrasenia" runat="server" AssociatedControlID="txtContrasenia" CssClass="label" Text="Contraseña"></asp:Label>
                        </div>
                        <asp:LinkButton ID="btnIngresar" runat="server" CssClass="btn btn-danger btnRed w-100" OnClick="btnIngresar_Click">INGRESAR</asp:LinkButton>
                    </div>
                    <!-- Fin Formulario Inicio de sesión -->
                    <!-- Formulario Registro de cuenta -->
                    <div id="divRegistroCuenta" runat="server" visible="false">
                        <h6 class="title text-center">Registro Candidato</h6>
                        ...
                        <asp:LinkButton ID="btnCrearCuenta" runat="server" CssClass="btn btn-primary btnPrimary w-100" OnClick="btnCrearCuenta_Click">CREAR CUENTA</asp:LinkButton>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <asp:LinkButton ID="btnGrabar" runat="server" OnClick="btnGrabar_Click" CssClass="btn btn-primary btnGris w-25">
                                            <i class="fa-regular fa-paper-plane"></i>&nbsp;Enviar
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="btnCerrar" runat="server" OnClick="btnCerrar_Click" CssClass="btn btn-danger btnRed w-25">
                        ...
                        <div class="col-12 mb-3">
                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center justify-content-center text-center mt-4">
                                <asp:LinkButton ID="lnkbtnRegistroSustentante" runat="server" CssClass="link-secondary text-decoration-none" OnClick="lnkbtnRegistroSustentante_Click">Registro Candidato</asp:LinkButton>
                                <asp:LinkButton ID="lnkbtnRegistroEmpresa" runat="server" CssClass="link-secondary text-decoration-none" PostBackUrl="~/RegistroEmpresa.aspx">Registro Empresa</asp:LinkButton>
                            </div>
                            <asp:LinkButton ID="lnkbtnRecuperarContrasenia" runat="server" CssClass="link-secondary text-decoration-none" data-bs-toggle="modal" data-bs-target="#miModal">Recuperar contraseña</asp:LinkButton>
                        </div>
                        <div class="col-12">
                            <a id="lnkbtnManualCandidato" runat="server" class="link-secondary opacity-50 text-decoration-none" href="recursos/Manual de usuario Candidato.pdf" target="_blank">Manual de Usuario Candidato</a>
                        </div>
                    </div>
