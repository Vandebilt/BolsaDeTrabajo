<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="Area.aspx.cs" Inherits="FACPYA.BolsaDeTrabajo.Presentacion.Area" %>
                ...
                <div class="row p-2">
                    <div class="card h-50vh">
                        <div class="text-center p-2">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">Módulo Área</h6>
                        </div>
                        <div class="card-body">
                            <!-- Controles -->
                            <div class="row g-3">
                                <div class="col-md-12 mb-5">
                                    <div class="form-floating">
                                        <asp:TextBox ID="txtArea" runat="server" CssClass="form-control textbox" MaxLength="50" onkeypress="return AllowOnlyLetters(event);" placeholder="Nombre Area"></asp:TextBox>
                                        <asp:Label ID="lblArea" runat="server" AssociatedControlID="txtArea" CssClass="label" Text="Nombre Area"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="card h-28vh">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                ALTA, BAJA Y MODIFICACION DE LAS AREAS DE INTERÉS Y EXPERIENCIA.
                            </div>
                ...
                <div class="row p-2">
                    <div class="card h-90vh">
                        <div class="text-center p-1">
                            <h5 class="card-title titulo"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Area</h5>
                            ...
                            <div class="row mt-0">
                                ...
                                <div class="col-md-10">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-floating">
                                                <asp:TextBox ID="txtBusquedaArea" runat="server" CssClass="form-control textbox" MaxLength="50" placeholder="Area"></asp:TextBox>
                                                <asp:Label ID="lblBusquedaArea" runat="server" AssociatedControlID="txtBusquedaArea" CssClass="label" Text="Area"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
