<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="CertificacionIdioma.aspx.cs" Inherits="FACPYA.BolsaDeTrabajo.Presentacion.CertificacionIdioma" %>
                ...
                <div class="row p-2">
                    <div class="card h-50vh">
                        <div class="text-center p-2">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">Módulo Certificación de Idioma</h6>
                        </div>
                        <div class="card-body">
                            <!-- Controles -->
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <asp:TextBox ID="txtCertificacionIdioma" runat="server" CssClass="form-control textbox" MaxLength="50" onkeypress="return AllowOnlyLetters(event);" placeholder="Certificación"></asp:TextBox>
                                        <asp:Label ID="lblCertificacionIdioma" runat="server" AssociatedControlID="txtCertificacionIdioma" CssClass="label" Text="Certificación"></asp:Label>
                                    </div>
                                </div>
                    ...
                    <div class="card h-28vh">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                ALTA, BAJA Y MODIFICACION DE LOS CERTIFICACIONES DE IDIOMA.
                            </div>
                ...
                <div class="row p-2">
                    <div class="card h-90vh">
                        <div class="text-center p-1">
                            <h5 class="card-title titulo"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Certificación de Idioma</h5>
                            ...
                            <div class="row mt-0">
                                ...
                                <div class="col-md-10">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <asp:TextBox ID="txtBusquedaCertificacion" runat="server" CssClass="form-control textbox" MaxLength="50" placeholder="Certificación"></asp:TextBox>
                                                <asp:Label ID="lblBusquedaCertificacion" runat="server" AssociatedControlID="txtBusquedaCertificacion" CssClass="label" Text="Certificación"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-floating">
                                                <asp:DropDownList ID="ddlBusquedaIdIdioma" runat="server" CssClass="form-control textbox select2-custom" placeholder="Idioma"></asp:DropDownList>
                                                <asp:Label ID="lblBusquedaIdIdioma" runat="server" AssociatedControlID="ddlBusquedaIdIdioma" CssClass="label" Text="Idioma"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
