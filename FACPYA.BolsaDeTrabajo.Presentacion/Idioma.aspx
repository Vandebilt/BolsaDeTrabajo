<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="Idioma.aspx.cs" Inherits="FACPYA.BolsaDeTrabajo.Presentacion.Idioma" %>
                ...
                <div class="row p-2">
                    <div class="card h-50vh">
                        <div class="text-center p-2">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">Módulo Idioma</h6>
                        </div>
                        <div class="card-body">
                            <!-- Controles -->
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <asp:TextBox ID="txtClave" runat="server" CssClass="form-control textbox" MaxLength="5" onkeypress="return AllowOnlyLetters(event);" placeholder="Clave"></asp:TextBox>
                                        <asp:Label ID="lblClave" runat="server" AssociatedControlID="txtClave" CssClass="label" Text="Clave"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-5">
                                    <div class="form-floating">
                                        <asp:TextBox ID="txtIdioma" runat="server" CssClass="form-control textbox" MaxLength="50" onkeypress="return AllowOnlyLetters(event);" placeholder="Idioma"></asp:TextBox>
                                        <asp:Label ID="lblIdioma" runat="server" AssociatedControlID="txtIdioma" CssClass="label" Text="Idioma"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="card h-28vh">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                ALTA, BAJA Y MODIFICACION DE LOS IDIOMAS.
                            </div>
                ...
                <div class="row p-2">
                    <div class="card h-90vh">
                        <div class="text-center p-1">
                            <h5 class="card-title titulo"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Idioma</h5>
                            ...
                            <div class="row mt-0">
                                ...
                                <div class="col-md-10">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <asp:TextBox ID="txtBusquedaClave" runat="server" CssClass="form-control textbox" MaxLength="5" placeholder="Clave"></asp:TextBox>
                                                <asp:Label ID="lblBusquedaClave" runat="server" AssociatedControlID="txtBusquedaClave" CssClass="label" Text="Clave"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-floating">
                                                <asp:TextBox ID="txtBusquedaIdioma" runat="server" CssClass="form-control textbox" MaxLength="50" placeholder="Idioma"></asp:TextBox>
                                                <asp:Label ID="lblBusquedaIdioma" runat="server" AssociatedControlID="txtBusquedaIdioma" CssClass="label" Text="Idioma"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
